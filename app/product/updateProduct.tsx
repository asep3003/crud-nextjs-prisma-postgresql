        ...
        <div className="modal-box">
          ...
          <form onSubmit={handleUpdate}>
            <div className="form-control w-full">
              ...
              <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} className="input input-border" placeholder="Product Name" />
            </div>
            <div className="form-control w-full">
              <label className="label font-bold">Price</label>
              <input type="text" value={price} onChange={(e) => setPrice(Number(e.target.value))} className="input input-border" placeholder="Price" />
            </div>
            <div className="form-control w-full">
